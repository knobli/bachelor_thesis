...
dann vom Entwickler erfasst werden. Der Anforderungskatalog wird nach der Vollendung nochmals mit den \glslink{stakeholder}{Stakeholdern} in einem Review durchgegangen (siehe 
\cite{req_eng_book}).
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.52]{images/project/projectplan.png}
