...
weitere gängige Algorithmentypen, welche für das Lösen von Optimierungsproblemen verwendet werden \cite{vazirani_algorithm}.
...
\begin{enumerate}
	...
	\item Iteration durch folgende Schritte, bis die Lösung den gewünschten Wert erreicht hat:
		...
		\item Evaluation: Mit Hilfe der Fitnessfunktion wird die erstellte Generation bewertet
      	...
      	\end{enumerate}
\end{enumerate}
Die Mutation und Rekombination können positive, negative oder neutrale Eigenschaften haben. Wie in der Natur überlebt der am besten Angepasste und somit wird die Lösung immer 
...
gelöst werden kann. Evolutionäre Algorithmen haben oft eine höhere Laufzeit und es ist nicht garantiert, dass sie immer die optimale Lösung liefern \cite{ea_useful}.
