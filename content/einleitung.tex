...
Die Laufzeit eines Backtracking Algorithmus ist Abhängig von den Anzahl an Möglichkeiten und der Verzweigungsrate. Im schlechtesten Fall beträg sie
$O(z^n)$, wobei $n$ die Anzahl Möglichkeiten und $z$ die Verzweigungsrate ist. Die Suche dauert oft lange, deshalb empfiehlt sich ein Backtracking 
...
eine existiert.
\todo{Laufzeit, Exaktheit, Schwierigkeit}
