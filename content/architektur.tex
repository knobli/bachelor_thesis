...
\glslink{ordbms}{Objektrelationale Datenbankmanagementsysteme (ORDBMS)} wurden entwickelt, um das \gls{rdbms} mit den Funktionen des objektorientierten Stils zu erweitern.
