...
(siehe \cite{wiki_restful}). Falls Fehler auftreten, werden die \glossarmark{HTTP-Statuscode} verwendet, um diese an den Aufrufer weiterzugeben.
...
abgeändert. Das Resultat wird mit dem Ergebnis der Validierung in die Datenbank gespeichert. Wenn der Nutzer den Status einer Berechunung abruft, fragt der Controller über den 
...
einer spaltenorientierten Datenbank liegt in der Performance bei \glossarmark{Aggregationsfunktionen}. Weiter führt dieser Datenbanktyp Veränderungen, 
