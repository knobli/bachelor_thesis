...
Das Anforderungsdokument legt die Basis für die Implementation. Es ist für den Verlauf des Projekts wichtig, dass zu Beginn Gedanken über die Anforderungen gemacht werden. Bei der Erstellung des Anforderungsdokuments werden verschiedene Betrachungsweisen aufgezeigt und die Herausforderung in verschiedenen Detaistufen angeschaut.
...
Der Systemkontext (siehe Abbildung \ref{fig:systemkontext}) zeigt, dass das System eine relevanten Schnittstellen zu den Nutzern und Verarbeitungssystem hat. Das System muss Daten für das Verarbeitungssystem zur Verfügung stellen und auch solche annehmen. Desweiteren wird das System von den Nutzern, Optimierungsproblemen und den dazgehörigen Algorithmen beeinflusst.

\FloatBarrier
\subsection{Systemumgebung}\label{systemumgebung}
Die Systemumgebung (siehe Abbildung \ref{fig:systemumgebung}) definiert die Ausgangslage für das Projekt. Am Anfang des Projekts war bekannt, dass Nutzer und ein Verarbeitungssystem Services des zu erstellenden System beziehen wollen. Die genaue Ausprägung dieser Services werden in diesem Kapitel behandelt.
...
\centering
  \begin{tabular}{ p{5cm} | p{5cm} | p{1.5cm} | p{1.5cm} }
	...
	\textbf{Phil Hofmann} (Vorsteher der Geschäftsführung der 200ok GmbH)						
								&	Phil ist der Auftraggeber in diesem Projekt. Er erwartet von der Machbarkeitsanalyse Informationen für ein mögliches Projekt zur Umsetzung der Idee.
												& 	Positiv		&	Hoch		\\ \hline
	\textbf{Potenzieller Kunde}
								&	Der potenzielle Kunde wünscht sich eine einfache Abwicklung für seine Probleme, er möchte sich nicht mit Algorithmen und Theoretischer Informatik rumschlagen.
												& 	Positiv		&	Hoch		\\ \hline
  \end{tabular}
   \caption{Liste der Stakeholder}\label{table:stakeholder}
\end{table}

\newpage
\section{Anforderungen}\label{sec.anfoderungen}
Bei dem Erfassen der Anforderungen wurden zuerst die Use-Cases definiert. Anhand der Use-Cases wurden dann die Anforderungen abgeleitet.
...
\centering
  \begin{tabular}{ l | p{10cm} }
	...
	\textbf{Auslösendes Ereignis} &	Nutzer möchte ein Problem lössen\\ \hline
	\textbf{Akteure}		&	Nutzer\\ \hline
	\textbf{Vorbedingung}	&	Das System bietet zur Lösung dieses Problem einen Aufruf\\ \hline
	\textbf{Nachbedingung}	&	Das System hat die nötigen Informationen für die Lösung des Problems und der Nutzer erhält eine ID mit welcher er den Status bzw. das Resultat abholen 						kann\\ \hline
...
\centering
  \begin{tabular}{ l | p{10cm} }
	...
	\textbf{Beschreibung}	&	Das System startet die Berechnung bim Verarbeitungssystem.\\ \hline
	\textbf{Auslösendes Ereignis} &	Nutzer möchte ein Problem lössen\\ \hline
...
\centering
  \begin{tabular}{ l | p{10cm} }
	...
	\textbf{Beschreibung}	&	Das Verareitungssystem benötigt für die Lösung des Problemes die Eingabeparameter\\ \hline
	\textbf{Auslösendes Ereignis}&	Das Verareitungssystem möchte die Eingabeparameter\\ \hline
	\textbf{Akteure}		&	Verareitungssystem\\ \hline
...
\centering
  \begin{tabular}{ l | p{10cm} }
	...
	\textbf{Akteure}		&	Verarbeitungssystem\\ \hline
	\textbf{Vorbedingung}	&	Das Verarbeitungssystem ist mit der Berechnung fertig\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Anforderungstyp}	&	Funktional Anforderung, Qualitätsanforderung, Randbedingung\\ \hline
...
Die Beschreibung der Anforderungen wurden zusätzlich mit einer Satzschablone (siehe Abbildung \ref{fig:satzschablone}) aus \cite{req_eng_book} erstellt. Dies hat den Vorteil, dass die Anforderungen normiert und exakt da herkommen. Die Abstufungen muss, sollte und wird werden verwendet um die Wichtigkeit der Anforderungen auszudrücken.
\begin{figure}[h]
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Anforderungstyp}	&	Funktional Anforderung\\ \hline
	\textbf{Name} 			&	Schnittstelle für reale Optimierungsprobleme\\ \hline
	...
	\textbf{Begründung} 		&	Die Schnittstellen ist die Anlaufstelle des Nutzers. Er beauftrag durch sie, das System eine Berechnung zu starten.\\ \hline
	\textbf{Akzeptanz Kriterium}	&	\begin{enumerate}
					\item Der Nutzer erhält mit der Schnittstelle eine Liste der bereitgestellten Berechnungsfunktionen
					\end{enumerate}
					\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Priorität} 		&	Must\\ \hline
	\textbf{Anforderungstyp}	&	Funktional Anforderung\\ \hline
	\textbf{Name} 			&	Rückgabe einer ID\\ \hline
	\textbf{Use Case} 		&	\nameref{table:use_case_1}\\ \hline
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben wurde, muss das System dem Ersteller eine ID zurück geben.\\ \hline
	\textbf{Begründung} 		&	Die ID hilft dem Nutzer den Status der Berechnung abzuholen und wird auch am Schluss für das Resultat benötigt.\\ \hline
	\textbf{Akzeptanz Kriterium}	&	\begin{enumerate}
					\item Der Nutzer erhält eine ID.
					\end{enumerate}
					\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Priorität} 		&	Must\\ \hline
	\textbf{Anforderungstyp}	&	Funktional Anforderung\\ \hline
	\textbf{Name} 			&	Speichern der Eingabeparametern\\ \hline
	\textbf{Use Case} 		&	\nameref{table:use_case_1}\\ \hline
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben wurde, muss das System fähig sein die Eingabeparameter abzuspeichern.\\ \hline
	...
	\textbf{Akzeptanz Kriterium}	&	\begin{enumerate}
					...
					\item Es gibt eine Fehlermeldung, falls bei der Speicherung etwas fehlschlägt.
					\end{enumerate}
					\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Priorität} 		&	Must\\ \hline
	\textbf{Anforderungstyp}	&	Funktional Anforderung\\ \hline
	\textbf{Name} 			&	Starten der Berechnung\\ \hline
	\textbf{Use Case} 		&	\nameref{table:use_case_2}\\ \hline
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben wurde, muss das System fähig sein die Berechnung beim Verarbeitungssystem zu starten.\\ \hline
	...
	\textbf{Akzeptanz Kriterium}	&	\begin{enumerate}
					\item Der Befehl für den Start wird versendet.
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben wurde, muss das System dem Verarbeitungssystem die Möglichkeit bieten die Eingabeparameter abzufragen.\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben wurde, muss das System dem Nutzer die Möglichkeit bieten den Status der Berechnung abzufragen.\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Anforderungstyp}	&	Funktional Anforderung\\ \hline
	\textbf{Name} 			&	Über Status informiert werden\\ \hline
	\textbf{Use Case} 		&	\nameref{table:use_case_4}\\ \hline
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben und dazu ein WebHook eingetragen wurde, muss das System den Nutzer über eine Änderung des Status über den Webhook informieren.\\ \hline
	\textbf{Begründung} 		&	Da die Verarbeitung asynchron läuft, weiss der Benutzer nicht, wann seine Berechnung fertig ist. Um ein ständiges Pollen zu verhindern, kann man WebHooks verwenden.\\ \hline
	\textbf{Akzeptanz Kriterium}	&	\begin{enumerate}
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Priorität} 		&	Must\\ \hline
	\textbf{Anforderungstyp}	&	Funktional Anforderung\\ \hline
	\textbf{Name} 			&	Speichern des  Resultats\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Use Case} 		&	\nameref{table:use_case_1}\\ \hline
	\textbf{Beschreibung} 	&	Das System sollte fähig sein die Lösung eines Problems so bereit zu stellen, dass kein Wissen über den Verarbeitungsprozess dahinter benötigt wird.\\ \hline
	\textbf{Begründung} 		&	Der Verarbeitungsprozess kann sehr spezifisch und von Problem zu Problem unterschiedlich sein, der Nutzer sollte eine möglichst einfache Schnittstelle dazu haben.\\ \hline
	\textbf{Akzeptanz Kriterium}	&	\begin{enumerate}
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Priorität} 		&	Should\\ \hline
	\textbf{Anforderungstyp}	&	Qualitätsanforderung\\ \hline
	\textbf{Name} 			&	Generische Eingabeparameter\\ \hline
	\textbf{Use Case} 		&	\nameref{table:use_case_1}\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Priorität} 		&	Should\\ \hline
	\textbf{Anforderungstyp}	&	Qualitätsanforderung\\ \hline
	\textbf{Name} 			&	Generische Eingabeparameter Verwaltung\\ \hline
	\textbf{Use Case} 		&	\nameref{table:use_case_1}\\ \hline
