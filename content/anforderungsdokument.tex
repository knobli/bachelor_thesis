...
Die Priorität der einzelnen Anforderungen ist wichtig, falls nicht alle Anforderungen umgesetzt werden können. Die Priorität wurde mit den Stakeholdern zusammen festgelegt und in \autoref{table:req_priorities} zur besseren Übersicht zusammengetragen.
\begin{table}[ht]
\centering
  \begin{tabular}{ l | l | l }
	\hline
	...
	RE-F2 			&  Rückgabe einer ID bei Beauftragung	& Must\\ \hline
	RE-F3 			&  Speicherung der Eingabeparameter	& Must\\ \hline
