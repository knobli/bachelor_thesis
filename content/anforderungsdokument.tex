...
Das Anforderungsdokument legt die Basis für die Implementation. Es ist für den Verlauf des Projekts wichtig, dass zu Beginn Gedanken über die Anforderungen gemacht werden. Bei der 
...
In diesem Abschnitt  wird die System- und Kontextabgrenzung dargelegt, die Systemumgebung beschrieben, die getroffenen Annahmen festgehalten und die verschiedenen Stakeholder mit 
...
Services des zu erstellenden System beziehen wollen. Die genaue Ausprägung dieser Services werden in diesem Kapitel behandelt.
...
Zwischen dem Endnutzer und dem zu erstellenden System existiert noch ein Sicherheitslayer, welcher nicht Teil dieser Arbeit ist. Später wird diese Projekt allenfalls mit diesem Sicherheitslayer 
erweitert oder eine übergeordnete Schnittstellen erstellt, welche diese dann anspricht. 
...
Die \glossarmark{Stakeholder} Analyse dient dem erfassen aller Nutzergruppen, die auf ein Projekt Einfluss haben. Zudem ermöglicht sie die Erfassung aller Gruppen, die potentiell 
Anforderungen an das Projekt stellen. In der der Tabelle \ref{table:stakeholder} wurden die \glossarmark{Stakeholder} für dieses Projekt zusammengetragen und ihre Erwartungen, ihre 
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Begründung} 		&	Die Schnittstellen ist die Anlaufstelle des Nutzers. Er beauftragt durch sie, das System eine Berechnung zu starten.\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben wurde, sollte das System dem Nutzer die Möglichkeit bieten den Status der Berechnung abzufragen.\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Use Case} 		&	\nameref{table:use_case_4}\\ \hline
	\textbf{Beschreibung} 	&	Falls eine Berechnung in Auftrag geben und dazu ein WebHook eingetragen wurde, sollte das System den Nutzer über eine Änderung des Status über 
						den Webhook informieren.\\ \hline
...
\centering
  \begin{tabular}{ l | p{8cm} }
	...
	\textbf{Begründung} 		&	Der Verarbeitungsprozess kann sehr spezifisch und von Problem zu Problem unterschiedlich sein, der Nutzer sollte eine möglichst einfache 
...
Die Priorität der einzelnen Anforderungen ist wichtig, falls nicht alle Anforderungen umgesetzt werden können. Die Priorität wurde mit den Stakeholdern zusammen festgelegt und in 
