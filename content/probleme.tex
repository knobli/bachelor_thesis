...
\end{figure}
	...
	\glossarmark{Eulerischenkreises} nicht erfüllt, werden alle Knoten mit ungeraden Anzahl von Kanten mit einem anderen solchen Knoten über die kürzeste Route verbunden. 
...
\end{figure}
	...
	\paragraph{Einfluss der Probleme auf die Komplexität}\mbox{}\\
	Wie bei der Knotenfärbung spielt die Anzal Kanten die Hauptrolle bei der Komplexität. Wie viele Knoten ein Graph hat und ob dieser bereits \glossarmark{eulersch} ist, hat einen 
	geringeren Einfluss.
...
Grundpfeiler der NP-Vollständigkeit, durch sie konnten für zahlreiche Probleme die NP-Vollständigkeit bewiesen werden.
	...
	Beim Erfüllbarkeitsproblem der \glossarmark{Aussagenlogik} ist zu überprüfen, ob eine beliebige \glossarmark{aussagenlogische} Formel erfüllbar ist.	
