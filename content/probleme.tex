...
\end{figure}
	...
	Das Briefträgerproblem ist an sich kein \gls{np}-vollständiges Problem, jedoch wurde für Varianten des Problems die \gls{np}-Vollständigkeit bewiesen. Für das `Rural Postman Problem`, bei 
	...
	Falls der Graph die Kriterien des \glslink{eulerkreis}{Eulerkreises} nicht erfüllt, werden alle Knoten mit ungerader Anzahl Kanten mit einem anderen solchen Knoten über die kürzeste 
