...
bei welchen auch ein Problem mit $k \ge 2$ in \glslink{polynomialzeit}{polynomieller} Zeit lösbar ist (siehe \cite{garey1979computers}).
...
\end{figure}
	...
	\glslink{eulerkreis}{Eulerkreises} nicht erfüllt, werden alle Knoten mit ungerader Anzahl von Kanten mit einem anderen solchen Knoten über die kürzeste Route verbunden. 
