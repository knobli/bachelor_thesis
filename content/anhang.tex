...
\paragraph{GET /algorithm/knapsack/{ID}} - Abrufen der Eingabedaten einer Rucksack Berechnung\mbox{}\\
...
\paragraph{GET /algorithm/timetableSchedules/{ID}} - Abrufen der Eingabedaten einer Stundenplan Berechnung\mbox{}\\
...
\paragraph{POST /algorithm/timetableScheduleSolutions} - Speichern einer Lösung für eine Stundenplan Berechnung\mbox{}\\
...
\paragraph{POST /algorithm/matchScheduleSolutions} - Speichern einer Lösung für eine Spielplan Berechnung\mbox{}\\
...
\paragraph{GET /matchScheduleSolutions/?computationId={ID}} - Abrufen des Resultats einer Spielplan Berechnung\mbox{}\\
